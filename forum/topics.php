				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="w-100 list-group" id="topic-list">
							...
							$topic = $conn->query("SELECT t.*,u.email as name FROM topics t inner join webuser u on u.email = t.user_id order by unix_timestamp(date_created) desc");
							...
							<li class="list-group-item mb-4">
								<div>
									<?php if($useremail == $row['user_id'] || $_SESSION['usertype'] == 1): ?>
								...
								<span class="float-right">
									<a href="index.php?page=view_forum&id=<?php echo $row['id'] ?>" class="btn btn-primary">Comment <i class="bi bi-send"></i></a>
								<?php 
