  ...
  <div class="container-fluid mt-2 mb-2">
      ...
      <div class="col-md-4 float-left">
        ...
        <div class=" dropdown mr-4">
            <a href="#" class="text-white dropdown-toggle"  id="account_settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $useremail ?> </a>
...
<script>
  $('#manage_my_account').click(function(){
    uni_modal("Manage Account","manage_user.php?id=<?php echo $useremail; ?>&mtype=own")
  })
