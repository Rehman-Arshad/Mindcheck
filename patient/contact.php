<?php
session_start();
include("patient_header_info.php"); // Include any necessary meta tags
include("patient_header.php"); // Include the navbar/header
?>
...
<?php include("patient_footer.php"); // Include the footer ?>
