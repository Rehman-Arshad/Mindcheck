...
<section class="breadcrumbs">
    <div class="container">
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <td width="13%" >
                    <a href="#" onclick="handleBackNavigation('../index.php')"><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            $sqlmain= "select patient.*, department.description as deptDescription, semester.description as semesterDescription from patient 
            ...
            $email=$row["pemail"];
            $address=$row["deptDescription"];
            $nic=$row['pnic'];
            $tele=$row['semesterDescription'];
            echo '
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nic" class="form-label">SAP ID: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Tele" class="form-label">Semester: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">Department: </label>
